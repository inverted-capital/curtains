const e=`You are an expert at goal detection.  Keep all your replies as short as possible.
  ...
  Only call the 'help' function one goal at a time.`;export{e as default};
